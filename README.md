...
| --- | --- | --- | --- | --- | --- | --- |
| Dark | <span style="display:inline-block;width:14px;height:14px;border:1px solid #ccc;background:#0F1116;margin-right:4px;"></span>`#0F1116` | <span style="display:inline-block;width:14px;height:14px;border:1px solid #ccc;background:#1A1D24;margin-right:4px;"></span>`#1A1D24` | <span style="display:inline-block;width:14px;height:14px;border:1px solid #ccc;background:#4B2C82;margin-right:4px;"></span>`#4B2C82` | <span style="display:inline-block;width:14px;height:14px;border:1px solid #ccc;background:#6F3CCF;margin-right:4px;"></span>`#6F3CCF` | <span style="display:inline-block;width:14px;height:14px;border:1px solid #ccc;background:#F4F5FB;margin-right:4px;"></span>`#F4F5FB` | <span style="display:inline-block;width:14px;height:14px;border:1px solid #ccc;background:#C5C8D4;margin-right:4px;"></span>`#C5C8D4` |
| Light | <span style="display:inline-block;width:14px;height:14px;border:1px solid #ccc;background:#F7F8FB;margin-right:4px;"></span>`#F7F8FB` | <span style="display:inline-block;width:14px;height:14px;border:1px solid #ccc;background:#E6E8EF;margin-right:4px;"></span>`#E6E8EF` | <span style="display:inline-block;width:14px;height:14px;border:1px solid #ccc;background:#4B2C82;margin-right:4px;"></span>`#4B2C82` | <span style="display:inline-block;width:14px;height:14px;border:1px solid #ccc;background:#6F3CCF;margin-right:4px;"></span>`#6F3CCF` | <span style="display:inline-block;width:14px;height:14px;border:1px solid #ccc;background:#0F1116;margin-right:4px;"></span>`#0F1116` | <span style="display:inline-block;width:14px;height:14px;border:1px solid #ccc;background:#4B5565;margin-right:4px;"></span>`#4B5565` |
